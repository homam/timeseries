...
(function() {
  var addBack, chart, collectLongTail, createSubMethodDeviceHierarchy, draw, drawSubMethodDeviceChart, groupBy, makeTreeByParentId, pack, subMethodDeviceConvChart, subMethodDeviceVisitsChart, sum, visitsBySubMethodsChart;
  ...
  require(['chart-modules/bar/chart'], function(barChart) {
    return console.log(typeof barChart);
  });
