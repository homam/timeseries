...
require ['chart.js', '../common/d3-tooltip.js'], (chartMaker, tooltip) ->
  testData = [
    {name: 'A', value: [{name: 'Alpha', value: 345, dev: 31}, {name: 'Beta', value: 45, dev: 11}]},
    {name: 'B', value: [{name: 'Alpha', value: 441, dev: 42}, {name: 'Beta', value: 105, dev: 6}]},
    {name: 'C', value: [{name: 'Alpha', value: 273, dev: 12}, {name: 'Beta', value: 89, dev: 30}]}
  ]

  chart = chartMaker().subDevs((d)->d.dev).tooltip(tooltip().text((d) -> JSON.stringify(d)))
