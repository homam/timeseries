...
(function() {
  var country, d, fromDate, timezone, toDate, _fn, _i, _ref, _ref1, _ref2;
  ...
  _fn = function() {
    ...
    return $.get('charts/devicedet-controls/data/sa-' + date + '.csv').done(function(txt) {
      return console.log(txt.length, date);
    });
  };
  for (d = _i = _ref = fromDate.valueOf() + timezone, _ref1 = toDate.valueOf() + timezone, _ref2 = 1000 * 60 * 60 * 24; _ref2 > 0 ? _i < _ref1 : _i > _ref1; d = _i += _ref2) {
    _fn();
  }

  console.log('req csv');

  require(['charts/devicedet-controls/data/sa-2013-08-01.csv'], function(f1) {
  ...
  require(['chart-modules/bar/chart', 'chart-modules/bar-groups/chart', 'chart-modules/pie/chart', 'chart-modules/common/d3-tooltip', 'chart-modules/utils/reduceLongTail', 'chart-modules/utils/sum'], function(barChart, barGroupsChart, pieChart, tooltip, reduceLongTail, sum) {
    var chart, createSubMethodDeviceHierarchy, draw, drawSubMethodDeviceChart, groupBy, makeTreeByParentId, subMethodDeviceConvChart, subMethodDeviceVisitsChart, sumVisitsWithChildren, v, visitsBySubMethodsChart, visitsBySubMethodsPieChart;
    ...
    drawSubMethodDeviceChart = function(node, data, compareConvWithOnlyConvertingDevices) {
      var allSubMethods, convHierarchy, existingSubMethods, m, rootName, targetDevices, totalVisits, visitsData, visitsHierarchy, zip, zipped, _j, _len, _ref3;
      zip = function(n) {
        var c, subscribers, visits, wurflIds, zipped, _j, _len, _ref3;
      ...
      _ref3 = allSubMethods.filter(function(s) {
    ...
    makeTreeByParentId = (function() {
      ...
      return function(cutLongTail, data) {
        var _j, _k, _ref3, _ref4, _results, _results1;
        (function() {
          _results = [];
          for (var _j = 0, _ref3 = data.length - 1; 0 <= _ref3 ? _j <= _ref3 : _j >= _ref3; 0 <= _ref3 ? _j++ : _j--){ _results.push(_j); }
          return _results;
        ...
        (function() {
          _results1 = [];
          for (var _k = 0, _ref4 = data.length - 1; 0 <= _ref4 ? _k <= _ref4 : _k >= _ref4; 0 <= _ref4 ? _k++ : _k--){ _results1.push(_k); }
          return _results1;
        }).apply(this).forEach(function(i) {
    ...
    return d3.csv('charts/devicedet-controls/data/iq-pin-android.csv', function(raw) {
