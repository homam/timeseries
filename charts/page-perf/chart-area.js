...
(function() {
  d3.csv('charts/page-perf/data/sc50time.csv', function(data) {
    ...
    return d3.csv('charts/page-perf/data/pages.csv', function(pages) {
      var $li, $offsets, $smoothers, $td, averageVisitsPerPage, chart, colors, convChart, dateRange, deHighlightPage, draw, filterByTime, graphData, groups, highlightPage, msInaDay, selectedPages, stdVisitsPerPage;
