...
(function() {
  ...
  exports.groupedBarsChart = function() {
    var chart, color, height, mainNameMap, mainValueMap, margin, subNameMap, subValueDevMap, subValueMap, width, x0, x1, xAxis, y, yAxis;
    ...
    chart = function(selection) {
      return selection.each(function() {
        ...
        chart.draw = function(hierarchy) {
          var $devG, $devLowerLine, $devUpperLine, $devrect, $legend, $legendEnter, $main, $rect, allMainKeys, allSubKeys;
