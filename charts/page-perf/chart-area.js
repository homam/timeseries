...
(function() {
  var chart, convChart, deHighlightPage, highlightPage, reDraw;
  ...
  reDraw = function(groupedData) {
    ...
    return convChart.addStack(groupedData);
  };
  ...
  d3.csv('charts/page-perf/data/sc50time.csv', function(data) {
    ...
    return d3.csv('charts/page-perf/data/pages.csv', function(pages) {
      var $li, $offsets, $smoothers, $td, averageVisitsPerPage, colors, dateRange, draw, filterByTime, graphData, groups, msInaDay, selectedPages, stdVisitsPerPage;
      ...
      $td = $li.selectAll('td.input').data(function(d) {
        return [d];
      }).enter().append("td").attr('class', 'input');
